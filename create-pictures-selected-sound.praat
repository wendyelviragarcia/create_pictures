...
#
# Citation: Elvira García, Wendy & Roseano, Paolo (2014). Create pictures with tiers v.4.1. Praat script. (Retrieved from http://stel.ub.edu/labfon/en/praat-scripts)
#
...
form Create_pictures
	...
	comment Do you want to save de picture?
	boolean PNG 1
    comment Where do you want to save the picture?
